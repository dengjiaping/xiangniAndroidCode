...
public class EaseChatRowImage extends EaseChatRowFile {
    ...
    protected void onSetUpView() {
        ...
        if (message.direct() == EMMessage.Direct.RECEIVE) {
            ...
            //            }
            if (imgBody.downloadStatus() == EMFileMessageBody.EMDownloadStatus.DOWNLOADING ||
                    imgBody.downloadStatus() == EMFileMessageBody.EMDownloadStatus.PENDING) {
                imageView.setImageResource(R.drawable.ease_default_image);
                //set the receive message callback
                setMessageReceiveCallback();
                EMClient.getInstance().chatManager().downloadAttachment(message);
                ...
                //寒冬该
                showImageViewCompat(thumbPath, imgBody.getLocalUrl(), message);
            }
        ...
        showImageViewCompat(thumbPath, filePath, message);
        handleSendMessage();
    }
    ...
    private void showImageViewCompat(final String thumbernailPath, final String localFullSizePath, final EMMessage message) {
