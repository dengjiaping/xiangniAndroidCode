 ...
 * 注意：需要添加权�?lt;uses-permission android:name="android.permission.INTERNET"/&gt;
 * 
 * @author hjgang
 */
public class HttpHelper {
	...
	static {
		if (null == httpClient) {
			...
			// 20000);
			// 以下代码处理了同�?��HttpClient同时发出多个请求时可能发生的多线程问�?
			...
			// 设置每个路由�?��连接�?
			ConnPerRouteBean connPerRoute = new ConnPerRouteBean(800);
	...
	public static void downloadFile(String url, File dest, OnResult<String> callback) throws IOException {
		HttpGet get = new HttpGet(url);
