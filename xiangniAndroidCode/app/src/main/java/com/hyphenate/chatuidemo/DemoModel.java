...
public class DemoModel {
     ...
     * @param ids
     */
    public void addDisableId(String ids){
        List<String> disabledIds = getDisabledIds();
        if(!disabledIds.contains(ids)){
            disabledIds.add(ids);
     ...
     * @param ids
     */
    public void deleteDisableId(String ids){
        List<String> disabledIds = getDisabledIds();
        if(disabledIds.contains(ids)){
            disabledIds.remove(ids);
            setDisabledIds(disabledIds);
        }
    }
