...
import com.github.viewpagerindicator.PageIndicator;
...
//        }
    ...
    /**
     * support return the viewpager
     *
     * @param adapter
     * @return
     */
    public AutoLoopViewPager setAdapter1(PagerAdapter adapter) {
        super.setAdapter(adapter);
        return this;
    }

    /**
     * should call after{@link #setAdapter(PagerAdapter)}or{@link #setAdapter1(PagerAdapter)}
     *
     * @param indicator
     * @return
     */
    public AutoLoopViewPager setIndicator(PageIndicator indicator) {
