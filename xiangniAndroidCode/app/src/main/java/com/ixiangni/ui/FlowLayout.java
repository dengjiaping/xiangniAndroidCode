...
public class FlowLayout extends ViewGroup {
    ...
    public FlowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        horizontalmargin = (int) typedArray.getDimension(R.styleable.FlowLayout_horspac,10);
        verticalmargin = (int) typedArray.getDimension(R.styleable.FlowLayout_verspac,10);
        typedArray.recycle();
    }
