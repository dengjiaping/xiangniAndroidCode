...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = MyApp.getInstance().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor =  MyApp.getInstance().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
