...
//        fragment.startActivityForResult(intent, requestCode);
    ...
    public static EMMessage createRPMessage(Context context, RedPacketInfo redPacketInfo, String toChatUsername) {
        ...
        message.setAttribute("yinxinhongbao", "yinxinhongbao");
        message.setAttribute("message",redPacketInfo.redPacketGreeting);    //  留言
        message.setAttribute("lucktype",redPacketInfo.redPacketType);  //  红包类型
        message.setAttribute("frientid",redPacketInfo.toUserId);   //对方id 或者 当前群Id
        message.setAttribute("redpacketId",redPacketInfo.redPacketId);   //   红包id

//        message.setAttribute("yinxinhongbao", "yinxinhongbao");
//        message.setAttribute("message",greetings);    //  留言
//        message.setAttribute("lucktype",redPacketType);  //  红包类型
//        message.setAttribute("frientid",specialReceiveId);   //对方id 或者 当前群Id
//        message.setAttribute("redpacketId",moneyID);   //   红包id


        return message;
    }

    public static boolean isRPMessage(EMMessage message){
        String yinxinhongbao = message.getStringAttribute("yinxinhongbao", "");
        if("yinxinhongbao".equals(yinxinhongbao)){
            return true;
        }
        return false;
    }
