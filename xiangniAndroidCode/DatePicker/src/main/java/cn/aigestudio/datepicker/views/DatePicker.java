...
//    private TextView tvEnsure;// 确定按钮显示
    ...
    public DatePicker(Context context, AttributeSet attrs) {
        ...
        View topView = inflater.inflate(R.layout.top_month, null);

        centerMonth = (TextView) topView.findViewById(R.id.tv_center_month);
        leftMonth = (TextView) topView.findViewById(R.id.tv_left_month);
        rightMonth = (TextView) topView.findViewById(R.id.tv_right_month);
        tvYear = (TextView) topView.findViewById(R.id.tv_year);
...
//                tvMonth.setText(mLManager.titleMonth()[month - 1]);
                centerMonth.setText(getMonthString(month)+"月");
                leftMonth.setText(getMonthString(month-1)+"月");
                rightMonth.setText(getMonthString(month+1)+"月");
